...
public class KosmoMemberChabun {
	...
	public static String ymdNum() {
		...
		try {
			...
			pstmt = conn.prepareStatement(KosmoMemberSqlMap.getHbeMemberChabunQuery());
			System.out.println("회원채번 쿼리 >>> \n" + KosmoMemberSqlMap.getHbeMemberChabunQuery());
			...
			System.out.println("commNO >>> : " + commNO);
			// 업무구분 코드 붙이기 : 회원 M
			commNO = KosmoMemberChabun.BIZ_GUBUN_M.concat(commNO);
			System.out.println("commNO >>> : " + commNO);
	...
	public static void main(String[] args) {
		...
		String commNO = KosmoMemberChabun.ymdNum();
