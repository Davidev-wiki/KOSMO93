...
import a.b.c.kosmo.login.service.KosmoLoginService;
import a.b.c.kosmo.login.service.KosmoLoginServiceImpl;
import a.b.c.kosmo.mem.scr.KosmoMember;
...
public class KosmoLogin extends JFrame implements ActionListener{
	...
	public void hLoginCheck(String hid, String hpw) {
		...
		try {
			...
			KosmoLoginService hls = new KosmoLoginServiceImpl();
