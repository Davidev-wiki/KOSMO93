...
import a.b.c.common.KosmoMemberChabun;
...
public class KosmoMember extends JFrame implements ActionListener {
	...
	// 회원정보 등록하기 
	public void hmInsert(   String hname, String hid, String hpw,
		...
		try {
			...
			KosmoMemberService hs = new KosmoMemberServiceImpl();		
			KosmoMemberVO hvo = null;
			hvo = new KosmoMemberVO();
			
			String hnum = KosmoMemberChabun.ymdNum();
