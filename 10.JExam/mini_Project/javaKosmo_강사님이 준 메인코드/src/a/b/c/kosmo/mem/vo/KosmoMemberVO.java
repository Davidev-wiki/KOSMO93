...
public class KosmoMemberVO {
	...
	public KosmoMemberVO(String hnum, String hname, String hid, 
	...
	// HbeMemberVO 프린트 함수 
	public static void printHbeMemberVO(KosmoMemberVO hvo) {
	...
	public static void printlnHbeMemberVO(KosmoMemberVO hvo) {
