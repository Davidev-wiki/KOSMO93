			...
			switch(isud) {
				...
				case 2:
					...
					try {
						...
						HbeMemberScr_1.hmemSelect(hnum);	
					}catch(Exception e) {						
					}								
					break;
				...
				case 3:
					try {	
						String sVal3[] = HbeMemberScr_1.getParameter(3);
						HbeMemberScr_1.hmemInsert(sVal3);	
					}catch(Exception e) {						
					}	
					break;
				...
				case 4:
					try {
						String sVal4[] = HbeMemberScr_1.getParameter(4);
						HbeMemberScr_1.hmemUpdate(sVal4);	
					}catch(Exception e) {						
					}						
					break;
				...
				case 5:
					...
					try {
						...
						HbeMemberScr_1.hmemDelete(hnum);	
					}catch(Exception e) {						
					}							
					break;					
			}
