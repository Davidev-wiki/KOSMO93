...
public class HbeMemberVO {
	...
	public static void printHbeMemberVO(HbeMemberVO hvo) {
		...
		System.out.print(hvo.getHbirth() 		+ ", ");
	...
	public static void printlnHbeMemberVO(HbeMemberVO hvo) {
		...
		System.out.println("hvo.getHbirth() 	>>> : " + hvo.getHbirth());
		System.out.println("hvo.getHgender() 	>>> : " + hvo.getHgender());
		System.out.println("hvo.getHtel() 		>>> : " + hvo.getHtel());
		System.out.println("hvo.getHhp() 		>>> : " + hvo.getHhp());
