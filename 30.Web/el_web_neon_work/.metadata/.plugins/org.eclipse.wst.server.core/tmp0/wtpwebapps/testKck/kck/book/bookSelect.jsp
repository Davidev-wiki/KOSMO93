...
<script type="text/javascript">
	...
	function bookUpdate(actionUpdate){
		...
		if ('U' == actionUpdate){
			document.bookUpdateForm.action="/testKck/book?isudtype=UOK";			
		}
		
		if ('D' == actionUpdate){
			document.bookUpdateForm.action="/testKck/book?isudtype=DOK";
		}
	...
	function checkAction(actionName){
		...
		if ('I' == actionName){	
			location.href="/testKck/kck/book/book.html";
		}
		if ('SALL' == actionName){			
			location.href="/testKck/book?isudtype=SALL";
		}
	}	
</script>
</head>
