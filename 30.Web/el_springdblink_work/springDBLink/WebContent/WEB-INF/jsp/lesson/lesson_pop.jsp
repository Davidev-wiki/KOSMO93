			...
			$(document).ready(function(){
				...
				$("#insertData").click(function(){
					...
					if(confirm('등록을 진행할까요?')){
						$("#lessonForm").attr("action","insertLesson.k");
						$("#lessonForm").submit();
					}
				});// end of $("#insertData").click(function()
						
				$("#updateData").click(function(){
					if(!validateForm()) return;
					if(confirm("수정을 진행할까요?")){
						$("#lessonForm").attr("action","updateLesson.k");
						$("#lessonForm").submit();
					}
				});// end of $("#updateData").click(function()
						
				$("#deleteData").click(function(){
					if(confirm('삭제를 진행할까요?')){
						$("#lessonForm").attr("action","deleteLesson.k");
						$("#lessonForm").submit();
					}
				});// end of $("#deleteData").click(function()
						
				$("#closeWindow").click(function(){
					window.close();
				}); // end of $("#closeWindow").click(function()
			}); // end of ready 
