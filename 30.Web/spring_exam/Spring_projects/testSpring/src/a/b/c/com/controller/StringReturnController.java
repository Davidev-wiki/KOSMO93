...
public class StringReturnController {
	...
	public String returnStringTest(Model m) {
		...
		m.addAttribute("mdata", "view에 데이터를 전달 할 때는 가능하면 Model인터페이스를 사용하자 >>> : ");
		//view 페이지는 함수 리턴형을 String으로 해서  String return value로 보낸다.
	...
	public void voidTest(Model md) {
		...
		md.addAttribute("mmmm", "스프링에서는 리턴타입 void도"
									+ "리턴이 됩니다!"
									+ "참 신기하지요?"
									+ "단, 리턴 조건은"
									+ "요청 url이름과"
