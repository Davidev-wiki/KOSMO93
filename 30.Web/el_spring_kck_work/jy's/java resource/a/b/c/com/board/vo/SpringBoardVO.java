...
public class SpringBoardVO {
	...
	public SpringBoardVO(String sbnum,  String sbsubject, 
				   ...
				   String sbdeleyn, String sbinsertdate, 
				   String sbupdatedate) {
	...
	public SpringBoardVO(String sbnum,  String sbsubject,
						 ...
						 String sbfile, String sbpw,
						 String sbdeleyn, String sbinsertdate, 
						 String sbupdatedate, String keyfilter, 
	...
	public String getSbdeleyn() {
		return sbdeleyn;
	}
	public void setSbdeleyn(String sbdeleyn) {
		this.sbdeleyn = sbdeleyn;
	}
	...
	public static void printVO(SpringBoardVO bvo) {
		...
		logger.info("삭제여부 >>> : " + bvo.getSbdeleyn());
