...
public class SpringRboardController {
	...
	public String rboardForm() {
		logger.info("SpringRboardController rboardForm() 함수 진입 >>> : ");
	...
	public String rboardInsert(SpringRboardVO rbvo) {
		logger.info("SpringRboardController rboardInsert() 함수 진입 >>> : ");
		logger.info("SpringRboardController rboardInsert rbvo.getSbnum() >>> : " 
						+ rbvo.getSbnum());
		logger.info("SpringRboardController rboardInsert rbvo.getRsbcontent() >>> : " 
						+ rbvo.getRsbcontent());
		
		String rsbnum = ChabunUtil.getRboardChabun("N", 
										chabunService.getRboardChabun().getRsbnum());
	...
	public String rboardSelect(SpringRboardVO rbvo) {
		logger.info("SpringRboardController rboardSelect() 함수 진입 >>> : ");
		logger.info("SpringRboardController rboardSelect rbvo.getRsbnum() >>> : "
						+ rbvo.getRsbnum());
		
		List<SpringRboardVO> list = springRboardService.rboardSelect(rbvo);
		logger.info("SpringRboardController rboardSelec list >>> : " + list);
	...
	@ResponseBody
	public String rbaordSelectAll(SpringRboardVO rbvo) {
		logger.info("SpringRboardController rbaordSelectAll() 함수 진입 >>> : ");
		
		// rbvo.setSbnum("B0001")
		logger.info("SpringRboardController rbaordSelectAll rbvo.getSbnum() >>> : "
						+ rbvo.getSbnum());
		
		List<SpringRboardVO> list = springRboardService.rboardSelectAll(rbvo);
		logger.info("SpringRboardController rbaordSelectAll list >>> : " + list);
	...
	public String rboardDelete(SpringRboardVO rbvo) {
		logger.info("SpringRboardController rboardDelete() 함수 진입 >>> : ");
		
		logger.info("SpringRboardController rboardDelete rbvo.getRsbnum() >>> : "
						+ rbvo.getRsbnum());
