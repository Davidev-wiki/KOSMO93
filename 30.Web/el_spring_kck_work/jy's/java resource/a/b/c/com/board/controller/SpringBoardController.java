...
public class SpringBoardController {
	...
	// 게시판 글 입력 폼
	// selectall.jsp에 location.href="boardForm.o"; 와 짝궁
	...
	public String boardInsert(HttpServletRequest req) {
		...
		logger.info("SpringBoardController boardInsert bool >>> : " + bool);
	...
	public String boardSelectPaging(SpringBoardVO bvo, Model model) {
		...
		logger.info("SpringBoardController boardSelectPaging 함수 진입 >> : 페이지 관련 로그 ============");
	...
	public String boardSelectAll(SpringBoardVO bvo, Model model) {
		...
		logger.info("SpringBoardController boardSelectAll bvo.getStartupdate() >>> : " + bvo.getStartdate());
	...
	public String boardUpdate(SpringBoardVO bvo, Model model) {
		...
		logger.info("SpringBoardControlelr boardUpdate nCnt >>> : " + nCnt);
	...
	public String boardDelete(SpringBoardVO bvo, Model model) {
		...
		logger.info("SpringBoardController boardDelte nCnt >>> : " + nCnt);
	...
	public Object boardPwCheck(SpringBoardVO bvo) {
		...
		logger.info("SpringBoardController boardPwCheck list.size() >> : " + list.size());
