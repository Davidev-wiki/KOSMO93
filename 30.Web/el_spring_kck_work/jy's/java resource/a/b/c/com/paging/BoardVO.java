...
public class BoardVO {
	...
	public BoardVO(String mnum,  String mtitle, 
				   String mname, String memail, 
				   String marea, String mpass, 
				   String mref,	 String mstep, 
				   String mdepth, String mwriteday, 
				   String mhits) {
		this.mnum = mnum;
		this.mtitle = mtitle;
		this.mname = mname;
	...
	public BoardVO(String mnum,     String mtitle, 
				   ...
				   String mref,     String mstep, 
				   String mdepth,   String mwriteday, 
				   String mhints,   String pageSize, 
				   String groupSize,String curPage, 
				   String totalCoun) {
