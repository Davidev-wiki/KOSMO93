...
<%
	...
	if(request.getParameter("curPage") != null){
		// 1
		pageSize = Integer.parseInt(request.getParameter("curPage"));
		System.out.println("curPage >>> : " + curPage);
	}
	if(request.getParameter("totalCount") != null){
		// 400
		pageSize = Integer.parseInt(request.getParameter("totalCount"));
		System.out.println("totalCount >>> : " + totalCount);
	}
	
	// 전체 게시물 수와 페이지 크기를 가지고 전체 페이지 개수를 계산
	// 소수점에 따라 계산상 오류가 없도록 함
