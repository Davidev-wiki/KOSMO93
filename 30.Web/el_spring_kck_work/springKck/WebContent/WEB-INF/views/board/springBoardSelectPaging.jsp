...
<html>
	<head>
		...
		<link rel="stylesheet" href="/springOjy/common/datepicker/jquery-ui-1.12.1/jquery-ui.min.css">
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				*/
				...
				}); // end of $(document).on("click","#searchBtn",function()
				// datapicker from~to 기간조회
				...
				}); // end of $(document).on("click","#U",function()
...
%>
			<tbody>
				<tr>
					...
					<td class="tt"><img src="/springKck/imgupload/sm_<%= bvo.getSbfile() %>"></td>
				</tr>
				<%
					}// end of for문
				%>
				...
				<tr>
					<td colspan="7">
						<jsp:include page="boardPaging.jsp" flush="true">
							<jsp:param name="url" value="boardSelectPaging.k"/>
