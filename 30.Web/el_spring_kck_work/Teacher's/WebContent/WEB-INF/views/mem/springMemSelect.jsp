...
<script type="text/javascript">
	...
	$(document).on("click", "#U", function(){
		...
		$("#memUpdateForm").attr({ "method":"POST"
			                      ,"action":"memUpdate.h"}).submit();
	});
	//  D
	$(document).on("click", "#D", function(){
		//alert("D >>> : ");
		$("#memUpdateForm").attr({ "method":"POST"
			                      ,"action":"memDelete.h"}).submit();
	});
	...
	$(document).on("click", "#SALL", function(){		
		$("#memUpdateForm").attr({"method":"GET", "action":"memSelectAll.h"}).submit();		
	});
</script>
</head>
...
<tr>
	...
	<td rowspan="5">
		<img class="photo" src="/springHbe/fileupload/member/<%= mvo.getMphoto() %>" alt="image">
	</td>	
</tr>
<tr>
	<td>이름</td>
