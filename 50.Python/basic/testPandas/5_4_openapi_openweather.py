...
# http://bulk.openweathermap.org/sample/city.list.json.gz   # api 요청시
...
apikey = "b5a8855bd3eef31d4696972a6009d8e6"

cities = ["Seoul,KR", "Tokyo,JP", "New York,US"]  # "도시이름(name), 국가(country)"
...
for name in cities:
    url = api.format(city=name, key=apikey)     # url = "api주소/weather?Q={"Seoul,KR", "b5a8855bd"}"
    r = requests.get(url)
